...
if choix_3 == "Salle mystère":
    ...
    if Int >= dé():
        ...
        if réponse == "4":
            delay_print("\nBravo, vous avez réussi à triomphé de ma terrible énigme, quelle attribut voulez-vous augmenter ?")
    ...
    while vie_mi > 0:
        ...
        if choix_6 == "Sort":
            if Int >= dé():
                if vie_max - Vie >= 2:
                    Vie += 2
                    delay_print("Vous décidez de lancer un sort de soin et récupérez 2 points de vie !")
                if vie_max - Vie == 1:
                    Vie += 1
                    delay_print("Vous décidez de lancer un sort de soin et récupérez 1 point de vie !")
                if vie_max - Vie == 0:
...
transition = "Vous avez vaincu enormément de monstres et maintenant, une porte terrifiante d'une hauteur inestimable se dresse devant vous","Des cadavres en bloque l'ouverture.","Il est impossible de l'ouvrir. En cherchant un moyen d'avancer vous remarquez une porte minuscule. Vous decidez d'y pénétrer"
...
sallecoffre = "\nCet endroit a l’air d’être une ancienne salle des coffres.","Vous fouillez rapidement la salle et le contenu de chacun des coffres mais celle-ci semble déjà avoir été pillée.","Cependant, au fond de la salle, une épée gigantesque est planté dans le sol.","Au niveau de son manche, il y a comme un réceptacle. Le seul objet ayant l'air d'y convenir est le diamant récupéré sur le Minotaure.","Une fois placé, l'épée vous est accessible et vous parait si légère."," Le destin vous fait une offrande, peut être que quelque chose vous attend dans la prochaine salle…","Une fois de retour devant la porte vous balayez les cadavres et ouvrez la porte sans aucun efforts."
...
delay_print("Le monstre s'écroule, vous vous précipitez vers lui pour lui asséner un dernier coup fatal.....")
print("""
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#-+#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
